...
if test "$PHP_NOISELIB" != "no"; then
  ...
  dnl idk 
  PHP_NEW_EXTENSION(noiselib, noiselib.cpp src/PerlinNoiseImpl.cpp src/SimplexNoiseImpl.cpp, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1 -std=c++14 -fno-strict-aliasing -DGSL_THROW_ON_CONTRACT_VIOLATION=1, yes)
