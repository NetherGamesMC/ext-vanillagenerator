...
class TerrainObjects {
 public:
   ...
   */
  static bool killWeakBlocksAbove(SimpleChunkManager &world, int_fast64_t x, int_fast32_t y, int_fast64_t z);
   ...
   */
  virtual bool Generate(SimpleChunkManager world, Random &random, int_fast64_t x, int_fast32_t y, int_fast64_t z) = 0;
};
